    ...
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Privacy Policy</Text>
        <Text style={styles.text}>
          Privacy Policy di www.ikawalieridiakashi.it
          {'\n\n'}
          ...
          {'\n'}
          Via Pasquale Berghini 40
          {'\n'}
          16132 Genova (GE)
          {'\n\n'}
          Indirizzo email del Titolare: info@ikawalieridiakashi.it
          {'\n\n'}
          Tipologie di Dati raccolti
          {'\n\n'}
          Fra i Dati Personali raccolti da questo sito, in modo autonomo o tramite terze parti, ci sono: Cookie; Dati di utilizzo; nome; cognome; numero di telefono; indirizzo; provincia; email; CAP; città.
          {'\n\n'}
          ...
          {'\n\n'}
          Se non diversamente specificato, tutti i Dati richiesti da questo sito sono obbligatori. Se l’Utente rifiuta di comunicarli, potrebbe essere impossibile proseguire con i servizi offerti da questo sito. Nei casi in cui questo sito indichi alcuni Dati come facoltativi, gli Utenti sono liberi di astenersi dal comunicare tali Dati, senza che ciò abbia alcuna conseguenza sulla disponibilità del Servizio o sulla sua operatività.
          {'\n\n'}
          ...
          {'\n\n'}
          I Dati dell’Utente sono raccolti per consentire al Titolare di fornire il Servizio, adempiere agli obblighi di legge, rispondere a richieste o azioni esecutive, tutelare i propri diritti ed interessi (o quelli di Utenti o di terze parti), individuare eventuali attività dolose o fraudolente, nonché per le seguenti finalità: Accesso agli account su servizi terzi, Commento dei contenuti e Contattare l’Utente.
          {'\n\n'}
          ...
          {'\n\n'}
          Questo sito può richiedere alcuni permessi Facebook che le consentono di eseguire azioni con l’account Facebook dell’Utente e di raccogliere informazioni, inclusi Dati Personali, da esso. Questo servizio permette a questo sito di connettersi con l’account dell’Utente sul social network Facebook, fornito da Facebook Inc.
          {'\n\n'}
          Per maggiori informazioni sui permessi che seguono, fai riferimento alla documentazione dei permessi Facebooked alla privacy policy di Facebook.
          {'\n\n'}
          ...
          {'\n\n'}
          Fornisce accesso ai post dello News Feed e permette al sito di effettuare ricerche su di esso.
          {'\n\n'}
          Mi Piace
          {'\n\n'}
          ...
          {'\n\n'}
          Questo tipo di servizi permettono a questo sito di prelevare Dati dai tuoi account su servizi terzi ed eseguire azioni con essi.
          {'\n\n'}
          ...
          {'\n\n'}
          Permessi richiesti: Accesso ai dati privati; Accesso allo News Feed; Mi Piace.
          {'\n\n'}
          ...
          {'\n\n'}
          Per necessità legate al funzionamento ed alla manutenzione, questosito e gli eventuali servizi terzi da essa utilizzati potrebbero raccogliere log di sistema, ossia file che registrano le interazioni e che possono contenere anche Dati Personali, quali l’indirizzo IP Utente.
          {'\n\n'}
